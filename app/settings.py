...
from app.utils.vault_connector import get_credentials

ENV = os.getenv('ENV', 'stg')
credentials = get_credentials('template', env=ENV)
urls = get_credentials('urls', env=ENV)
...
# Slack
SLACK_URL_SERVICE = f'{urls["slack"]}/api/chat.postMessage'
SLACK_TOKEN = credentials['slack_token']

# Rabbit
BROKER_URL = credentials['broker_url']
BROKER_LOGIN = credentials['broker_login']
